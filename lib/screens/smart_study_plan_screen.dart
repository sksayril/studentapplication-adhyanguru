...
class SmartStudyPlanScreen extends StatefulWidget {
  const SmartStudyPlanScreen({Key? key}) : super(key: key);
  ...
  void _addWelcomeMessage() {
    setState(() {
      _messages.add(ChatMessage(
        text: 'Hello! I\'m your Smart Study Planner. I can help you create a personalized study schedule, set goals, manage your time, and optimize your learning. What would you like to plan today?',
        isUser: false,
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(
              'Get personalized study schedules and optimize your learning time. Ask me anything about planning your studies!',
              ...
              child: Container(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    hintText: 'Ask about your study plan...',
